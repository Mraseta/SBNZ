...
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj1','srbija','novi sad','detelinara1',0,'pera1',100,1);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj2','srbija','novi sad','detelinara2',0,'pera1',150,2);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj3','srbija','novi sad','detelinara3',0,'pera1',200,5);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj4','srbija','novi sad','detelinara4',0,'pera2',250,8);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj5','srbija','novi sad','detelinara5',0,'pera2',120,15);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center) values ('smestaj6','srbija','novi sad','detelinara6',0,'pera2',130,20);
