insert into sbnz.user (username, password,first_name,last_name,category,type) values ('user', '123','nikola','roncevic',0,0);
insert into sbnz.user (username, password,first_name,last_name,category,type) values ('owner', '123','marko','markovic',0,1);
insert into sbnz.user (username, password,first_name,last_name,category,type) values ('admin', '123','stipe','stipevic',0,2);
...
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center,discount) values ('smestaj4','srbija','novi sad','detelinara4',0,'pera1',250,8,0);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center,discount) values ('smestaj5','srbija','novi sad','detelinara5',0,'pera1',120,15,0);
insert into sbnz.accommodation(name,country,city,address,zone,owner,price_per_day,distance_from_center,discount) values ('smestaj6','srbija','novi sad','detelinara6',0,'pera1',130,20,0);
